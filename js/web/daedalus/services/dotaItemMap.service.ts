...
//http://cdn.dota2.com/apps/dota2/images/items/item_blades_of_attack_lg.png

export class ItemMap {
    
    public itemDict: { [key: string]: string };
    
    public static HERO_IMG_BASE_URL: string = 'http://cdn.dota2.com/apps/dota2/images/items/';
    ...
    public toPhotoString(itemId: string, size: imageSize, itemName?: boolean): string {        
        if (!itemName) 
